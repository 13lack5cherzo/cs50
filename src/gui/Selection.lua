...
function Selection:init(def)
    ...
    -- display cursor by default
    self.noCursor = def.noCursor and true or false
...
function Selection:render()
    ...
    for i = 1, #self.items do
        ...
        -- draw selection marker if we're at the right index, and cursor is on
        if (i == self.currentSelection) and (not self.noCursor) then
