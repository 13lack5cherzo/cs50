...
function StartState:render()
    ...
    love.graphics.printf('arrow keys: move', TILE_SIZE, VIRTUAL_HEIGHT/TILE_SIZE, VIRTUAL_WIDTH, 'left')
    love.graphics.printf('space: sword', TILE_SIZE, VIRTUAL_HEIGHT/TILE_SIZE + TILE_SIZE, VIRTUAL_WIDTH, 'left')
    love.graphics.printf('enter: lift/throw', TILE_SIZE, VIRTUAL_HEIGHT/TILE_SIZE + 2*TILE_SIZE, VIRTUAL_WIDTH, 'left')
