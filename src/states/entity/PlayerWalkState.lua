...
function PlayerWalkState:init(entity, level)
    ...
    -- pokemon encounter probability (100% when debugging)
    self.encounterProb = DEBUG_MODE and 100 or 10 -- %
...
function PlayerWalkState:checkForEncounter()
    ...
    if self.level.grassLayer.tiles[y][x].id == TILE_IDS['tall-grass'] and math.random(100) <= self.encounterProb then
